...
class MNIST3dFullLiquidConf3(BaseModel):
    def __init__(self):
        super(MNIST3dFullLiquidConf3, self).__init__()
        self.conv1 = torch.nn.Conv2d(1, 6, 5)
        self.conv2 = torch.nn.Conv2d(6, 16, 3)
...
class MNIST3dFullLiquidConf4(BaseModel):
    def __init__(self):
        super(MNIST3dFullLiquidConf4, self).__init__()
        self.conv1 = torch.nn.Conv2d(1, 6, 5)
        self.conv2 = torch.nn.Conv2d(6, 16, 3)
...
class MNIST3dFullLiquidConf5(BaseModel):
    def __init__(self):
        super(MNIST3dFullLiquidConf5, self).__init__()
        self.conv1 = torch.nn.Conv2d(1, 6, 5)
        self.conv2 = torch.nn.Conv2d(6, 16, 3)
