...
class CNNBaselineLarge(BaseModel):
    def __init__(self):
        super(CNNBaselineLarge, self).__init__()
        ...
        self.conv7 = torch.nn.Conv2d(128, 256, 3, 1, 1)
        self.conv8 = torch.nn.Conv2d(256, 256, 3, 1, 1)
        self.conv9 = torch.nn.Conv2d(256, 256, 3, 1, 1)
        self.conv10 = torch.nn.Conv2d(256, 256, 3, 1, 1)
